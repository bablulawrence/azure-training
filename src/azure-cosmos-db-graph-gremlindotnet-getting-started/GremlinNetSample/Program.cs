...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string Host = "cosmosdb-gremlin-779.gremlin.cosmosdb.azure.com";
        private static string PrimaryKey = "UwXyNp2IChVc1NaTGy1lA5vG96z6q86kb6okmai5VbeaWdAfWnaQ0JA0FCBT46Hvm30IEpdJUx8pDUHhgX0b5g==";
        private static string Database = "sample-database";
        private static string Container = "sample-graph";
