...
try:
    client = client.Client('wss://cosmosdb-gremlin-779.gremlin.cosmos.azure.com:443/', 'g',
                           username="/dbs/sample-database/colls/sample-graph",
                           password="UwXyNp2IChVc1NaTGy1lA5vG96z6q86kb6okmai5VbeaWdAfWnaQ0JA0FCBT46Hvm30IEpdJUx8pDUHhgX0b5g==",
